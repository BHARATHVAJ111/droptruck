...
class SupplierController extends Controller
{
    ...
    {
        // $suppliers = Supplier::orderBy('id', 'desc')->groupBy('contact_number')->get();
        $suppliers = DB::table('suppliers as s1')
    ...
    public function create($indentId = null)
    {
        try {
            ...
            return redirect()->route('supplier_advances.create', ['id' => $indentId])->with('error', 'Error retrieving indent. Please try again.');
        }
    }
