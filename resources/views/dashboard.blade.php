...
<div class="main">
    <div class="row align-items-center">
        <div>
            <h2 class="btn btn-primary text-white fw-bolder float-end mt-1">User Type: {{ auth()->user()->name }}</h2>
        </div>
        <div class="col">
            ...
            <div class="modal fade container-fluid" id="createIndentModal" tabindex="-1" aria-labelledby="createIndentModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-xl" role="document">
                    ...
                    <div class="modal-content">
                        ...
                        <!-- <div class="modal-header fw-bolder text-white" style="background:#F98917;">
                            Create Indent
                        </div> -->
    ...
    <div class="top mt-2 mb-0">
        <div class="d-flex flex-row gap-1">
            <div class="indents p-3">
                ...
                <div>
                    <p class="shade">{{$confirmedtrips}}</p> Complete Trips
                </div>
            </div>
        </div>
    </div>
