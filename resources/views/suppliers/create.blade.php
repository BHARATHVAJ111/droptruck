    ...
    <div class="add-new-supplier">
        ...
        <div class="row gap-3  d-flex justify-content-center">
            <div class="form-group  col-lg-5 mb-3">
                ...
                <img id="panCardPreview" src="#" alt="Pan Card Preview" style="display: none; max-width: 100%; height: auto;">
                <div id="panpreview" class="preview-container" style="display: none; max-width: 100%; height: auto;"></div>
                @error('pan_card')
                    <div class="text-danger">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="form-group  col-lg-4 mb-3">
                ...
                <img id="businessCardPreview" src="#" alt="Business Card Preview" style="display: none; max-width: 100%; height: auto;">
                <div id="businesspreview" class="preview-container" style="display: none; max-width: 100%; height: auto;"></div>
                @error('business_card')
                    <div class="text-danger">{{ $message }}</div>
                @enderror
            </div>
        ...
        <div class="row gap-3  d-flex justify-content-center">
            <div class="form-group  col-lg-5 mb-3">
                ...
                <img id="bankDetailsPreview" src="#" alt="Bank Details" style="display: none; max-width: 100%; height: auto;">
                <div id="bankpreview" class="preview-container" style="display: none; max-width: 100%; height: auto;"></div>
                @error('bank_details')
                    <div class="text-danger">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="form-group  col-lg-4 mb-3">
                ...
                <img id="memoPreview" src="#" alt="Others Preview" style="display: none; max-width: 100%; height: auto;">
                <div id="memoFilePreview" class="preview-container" style="display: none; max-width: 100%; height: auto;"></div>
                @error('memo')
                    <div class="text-danger">{{ $message }}</div>
                @enderror
            </div>
        ...
        jQuery.ajax({
            ...
            success: function(result) {
                ...
                if(result != '') {
                    ...
                    bankDetailsFileType = getFileExtension(result.bank_details);
                    ewayBillFileType = getFileExtension(result.eway_bill);
                    tripsInvoiceFileType = getFileExtension(result.trips_invoices);
                    otherDocFileType = getFileExtension(result.other_document);
                    ...
                    if(ewayBillFileType === 'pdf') {
                        $('#ewayBillPreview').hide();
                        $('#ewaypreview').show();
                        ewayPreviewDiv.innerHTML = '';
                        const imgElement = document.createElement('img');
                        imgElement.height = 100; // Set the height to 100 pixels
                        imgElement.width = 100; // Set the width to 100 pixels
                        imgElement.src = '/images/dashboard/pdf.png';
                        ewayPreviewDiv.appendChild(imgElement);
                    } else {
                        $('#ewayBillPreview').attr('src', ewayBillUrl);
                        $('#ewayBillPreview').show();
                    }
                    
                    if(tripsInvoiceFileType === 'pdf') {
                        ...
                        imgElement.width = 100; // Set the width to 100 pixels
                        imgElement.src = '/images/dashboard/pdf.png';
                        invoicePreviewDiv.appendChild(imgElement);
                    } else {
                        $('#tripsInvoicesPreview').attr('src', tripsInvoiceUrl);
                        $('#tripsInvoicesPreview').show();
                    }
                    if(otherDocFileType === 'pdf') {
                        $('#otherDocumentsPreview').hide();
                        $('#otherspreview').show();
                        othersPreviewDiv.innerHTML = '';
                        const imgElement = document.createElement('img');
                        imgElement.height = 100; // Set the height to 100 pixels
                        imgElement.width = 100; // Set the width to 100 pixels
                        imgElement.src = '/images/dashboard/pdf.png';
                        othersPreviewDiv.appendChild(imgElement);
                    } else {
                        $('#otherDocumentsPreview').attr('src', otherDocUrl);
                        $('#otherDocumentsPreview').show();
                    }
