                        ...
                        <li class="nav-item">
                            <a href="{{route('truck.truck-types')}}" class="nav-link px-0 {{ request()->route()->getName() === 'truck.truck-types' ? 'active' : '' }}">
                                <span class="ms-1 d-none d-sm-inline">
                                    ...
                                    <span class="ms-1"> Truck Type <i class="fas fa-arrow-right"></i></span>
                                </span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{route('materials.index')}}" class="nav-link px-0 {{ request()->route()->getName() === 'materials.index' ? 'active' : '' }}">
                                <span class="ms-1 d-none d-sm-inline">
                                    <img src="{{ asset('images/dashboard/trucks.png') }}" height="20" width="20" class="img">
                                    <span class="ms-1"> Martial Type <i class="fas fa-arrow-right"></i></span>
                                </span>
                            </a>
                        </li>
