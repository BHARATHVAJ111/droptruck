    ...
    <form action="{{ route('indents.store') }}" method="POST" id="indentForm">
            ...
            <div class="col-md-6">
                <div class="row">
                    <div class="form-group mt-1 col-md-6">
                        ...
                        <input type="text" class="form-control form-control-sm  @error('number_1') is-invalid @enderror" id="number_1" name="number_1" pattern="[0-9]{10}" title="Please enter a 10-digit number">
                        @error('number_1')
                ...
                <div class="row">
                    ...
                    <div class="form-group mt-1 col-md-6"  id="body_type_option">
                        ...
                        <select class="form-select form-select-sm @error('body_type') is-invalid @enderror" id="body_type" name="body_type">
                            <option value="select">select</option>
            ...
            <div class="col-md-6 ms-2">
                <div class="form-group mt-1" id="truck_type_option">
                    ...
                    <div class="input-group">
                        <select name="truck_type_id" id="truck_type_id" class="form-control form-control-sm @error('truck_type_id') is-invalid @enderror">
                ...
                <div class="row">
                    <div class="form-group mt-1 col-md-6">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control form-control-sm @error('weight') is-invalid @enderror" id="weight" name="weight">
        ...
        <input type="hidden" id="drop_location_id" name="drop_location_id">
         ...
         <div class="form-group mt-1">
            ...
            <input class="form-control form-control-sm pac-target-input" type="text" name="pickup_location" id="pickup_location">
