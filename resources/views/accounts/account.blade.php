...
<?php //echo '<pre>'; print_r($extraCostDetails); exit; ?>
<body>
    <div class="m-3">
            ...
            <div class="col-lg-6">
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        <th>Balance Amount -
                            @if($drivers->indent->indentRate->isNotEmpty())
                            {{ $drivers->indent->indentRate->where('is_confirmed_rate', '1')->first()->rate }}
                            @else
                            N/A
                            @endif
                    </tr>
...
<!-- Modal -->
        ...
        <div class="modal fade" id="supplierPriceModal" tabindex="-1" role="dialog" aria-labelledby="supplierPriceModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="rateModalLabel">Extra Cost </h5>
                    </div>
                    <div class="modal-body">
                        <form method="POST">
                          @csrf
...
<script>
    ...
    function confirmToPod(indentId) {
        ...
        console.log(isCostConfirmed);
        console.log(isExtraCostDetails);
        console.log(extra_cost_type); 
